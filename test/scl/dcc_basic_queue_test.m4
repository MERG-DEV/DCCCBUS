...
beginning_of_test(865)
    begin_test
      ...
      log(1 in transmitter 15 in Event Tx queue 1 in DCC packet queue)
      input_dcc_basic_acc_pair(102, Deactivate)
      log(1 in transmitter 15 in Event Tx queue 2 in DCC packet queue)
      input_dcc_basic_acc_pair(103, Activate)
      log(1 in transmitter 15 in Event Tx queue 3 in DCC packet queue)
      input_dcc_basic_acc_pair(104, Deactivate)
      log(1 in transmitter 15 in Event Tx queue 4 in DCC packet queue)
      input_dcc_basic_acc_pair(105, Activate)
      log(1 in transmitter 15 in Event Tx queue 5 in DCC packet queue)
      input_dcc_basic_acc_pair(106, Activate)
      log(1 in transmitter 15 in Event Tx queue 6 in DCC packet queue)
      input_dcc_basic_acc_pair(107, Activate)
      log(1 in transmitter 15 in Event Tx queue 7 in DCC packet queue)
      input_dcc_basic_acc_pair(108, Activate)
      log(1 in transmitter 15 in Event Tx queue 8 in DCC packet queue)
      input_dcc_basic_acc_pair(109, Activate)
      log(1 in transmitter 15 in Event Tx queue 9 in DCC packet queue)
      input_dcc_basic_acc_pair(110, Activate)
      log(1 in transmitter 15 in Event Tx queue 10 in DCC packet queue)
      input_dcc_basic_acc_pair(111, Activate)
      log(1 in transmitter 15 in Event Tx queue 11 in DCC packet queue)
      input_dcc_basic_acc_pair(112, Activate)
      log(1 in transmitter 15 in Event Tx queue 12 in DCC packet queue)
      input_dcc_basic_acc_pair(113, Activate)
      log(1 in transmitter 15 in Event Tx queue 13 in DCC packet queue)
      input_dcc_basic_acc_pair(114, Activate)
      log(1 in transmitter 15 in Event Tx queue 14 in DCC packet queue)
      input_dcc_basic_acc_pair(115, Activate)
      log(1 in transmitter 15 in Event Tx queue 15 in DCC packet queue)
      --
