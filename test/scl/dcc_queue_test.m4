...
beginning_of_test(2332)
    begin_test
      ...
      input_dcc_basic_acc_pair(30, Activate)
      ...
      input_dcc_basic_acc_pair(147, Activate)
      ...
      log(1 in transmitter 31 in Event Tx queue 33 in DCC packet queue)
      tx_wait_for_node_message(OPC_ASON, 0, 0, 0, EN high,  30, EN low)
      log(1 in transmitter 31 in Event Tx queue 32 in DCC packet queue)
      ...
      log(1 in transmitter 16 in Event Tx queue 0 in DCC packet queue)
      tx_wait_for_node_message(OPC_ASON, 0, 0, 0, EN high, 147, EN low)
      log(1 in transmitter 15 in Event Tx queue 0 in DCC packet queue)
